...
<ul className={style.menu}>
  <li>
    ...
    <label htmlFor={style.menuBtn1} className={style.labelBtn} onclick=""><i className="fa-solid fa-caret-right"></i> 제품별</label>
  ...
  <li>
    ...
    <label htmlFor={style.menuBtn2} className={style.labelBtn} onclick=""><i className="fa-solid fa-caret-right"></i> 유형별</label>
