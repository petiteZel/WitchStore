...
function Type() {
  return (
    <main id={style.loginArea} role="main">
      {/* <!-- 배경 별 --> */}
        ...
        <div className={style.mainPage} id={style.mainPage}>
          ...
          <div className={`${style.questionBox} ${style.firstTuestion}`}>
            ...
            <div className={style.selectBox}>
              <button
                className={`${style.box} ${style.selectAbox}`}
                value="A_1"
              >
                <div className={style.selectA}>
                  <div className={style.icon}>
                    <img id={style.gameImg} src={gameImgRoot} alt="gameImg" />
                  </div>
                  <p>예능, 오락</p>
                </div>
              </button>
              ...
              <button
                className={`${style.box} ${style.selectBbox}`}
                value="B_1"
              >
                <div className={style.selectB}>
                  <div className={style.icon}>
                    <img id={style.newsImg} src={newsImg} alt="newsImg" />
                  </div>
                  <p>뉴스, 시사, 퀴즈</p>
                </div>
              </button>
          ...
          <div className={`${style.questionBox} ${style.secondQuestion}`}>
            ...
            <div className={style.selectBox}>
              ...
              >
                <div className={style.selectA}>
                  <div className={style.icon}>
                    <img id={style.bowingImg} src={bowingImg} alt="bowingImg" />
                  </div>
                  <p>바로 사과하고 화해한다</p>
                </div>
              </button>
          ...
          <div className={`${style.questionBox} ${style.thirdQuestion}`}>
            ...
            <div className={style.selectBox}>
              ...
              >
                <div className={style.selectA}>
                  <div className={style.icon}>
                    <img id={style.pilotImg} src={pilotImg} alt="pilotImg" />
                  </div>
                  <p>역무원</p>
                </div>
              </button>
              ...
              >
                <div className={style.selectB}>
                  <div className={style.icon}>
                    <img id={style.mapImg} src={mapImg} alt="mapImg" />
                  </div>
                  <p>구내지도 또는 안내표지</p>
                </div>
              </button>
          ...
          <div className={`${style.questionBox} ${style.fifthQuestion}`}>
            ...
            <div className={style.selectBox}>
              ...
              >
                <div className={style.selectB}>
                  <div className={style.icon}>
                    <img id={style.smileImg} src={smileImg} alt="smileImg" />
                  </div>
          ...
          <div className={`${style.questionBox} ${style.sixthQuestion}`}>
            ...
            <div className={style.selectBox}>
              ...
              >
                <div className={style.selectA}>
                  <div className={style.icon}>
                    <img id={style.ear_img} src={earImg} alt="earImg" />
                  </div>
...
아이돌 타입은 상대를 기쁘게 하는 것에 보람을 느끼기 때문에,우울할 때일수록 사람들과의 교류가 필요합니다.
          ...
          <div className={style.resultTeletTox}>
            ...
            <button
              className={`${style.resultBox} ${style.tryAgainBtn}`}
              id={style.tryAgainBtn}
            >
              테스트 다시 하기
            </button>
            ...
            <button
              className={`${style.resultBox} ${style.shoppingBtn}`}
              id={style.shoppingBtn}
            >
              다른 제품 보러가기
            </button>
          </div>
